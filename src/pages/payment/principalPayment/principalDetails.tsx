...
// Configure dayjs
dayjs.locale("en");
export default function PrincipalAmountDetails({ accountData, data }: any) {
  ...
  const Loanfields = [
    ...
    },
    {
      label: "Loan Tenure",
      value:
        `${accountData?.loanId?.maturityPeriod ?? "N/A"}  Months ` || "N/A",
    },
    {
      label: "Delivery Date",
    ...
    {
      label: "Loan Amount",
      value: fCurrency(accountData?.principalAmt) || "N/A",
    },
  ];
