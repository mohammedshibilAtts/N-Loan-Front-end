...
export const IncomeEntriesForm: React.FC<Props> = ({
    ...
    const fields: ValidationField[] = [
        ...
        { name: "subIncome", label: "Sub Income", type: "dropdown", required: true },
        {
            name: "paymentMethod",
    ...
    const formik: any = useFormik({
        initialValues: {
            ...
            subIncome: selectedEntry?.subIncome?._id || selectedEntry?.subIncome || "",
            paymentMethod: selectedEntry?.paymentMethod?._id || selectedEntry?.paymentMethod || "",
            paymentProvider: selectedEntry?.paymentProvider?._id || selectedEntry?.paymentProvider || "",
                                ...
                                {field.type === "dropdown" ? (
                                    ...
                                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                                        <DatePicker
                                            ...
                                            onChange={(v) =>
                                                formik.setFieldValue("incomeDate", v)
                                            }
                                        />
