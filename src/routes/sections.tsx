...
const IncomeEntriesTable = lazy(() => import('../pages/income/incomeEntries/incomeEntriesTable'))
...
const OverDueReport = lazy(() => import('../newReports/overdue/overDueReport'))
const LoanReports = lazy(() => import('../reports/accounts reports/LoanReports'))
const LoanAccountReport = lazy(() => import('../newReports/loanAccount/loanAccountReport'))
...
const StockLedgerReport = lazy(() => import('../newReports/stockLedger/stockLedgerReport'))
  ...
  return useRoutes([
    {
      ...
      children: [
        ...
        { path: '/income/incomeEntries', element: <IncomeEntriesTable /> },
